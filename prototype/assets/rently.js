...
const LISTINGS=[
  {id:'l1',title:'Premium Event Tent & Décor Package',cat:'event',catName:'Event & Party',price:45000,unit:'day',rating:4.8,reviews:120,loc:'Lekki, Lagos',providerId:'ec',provider:'EventCraft NG',pAvatar:'EC',verified:true,mode:'request',deposit:20000,desc:'A complete 20×30ft weatherproof event setup with elegant drapery and coordinated décor — delivery and setup crew included.',specs:['20×30ft weatherproof marquee','Full drapery & lighting rig','Setup and breakdown crew included','Seats up to 150 guests']},
  {id:'l2',title:'DJI Mavic 3 Pro Drone Kit',cat:'av',catName:'AV Equipment',price:25000,unit:'day',rating:4.7,reviews:86,loc:'Victoria Island, Lagos',providerId:'al',provider:'AeroLens Rentals',pAvatar:'AL',verified:true,mode:'instant',deposit:50000,desc:'Cinema-grade 5.1K drone with 3 batteries, ND filters and a hard case — ideal for weddings and real estate shoots.',specs:['5.1K/50fps Hasselblad camera','3 batteries (~135 min total flight)','ND filter set + hard case','Insured against accidental damage']},
  {id:'l3',title:'Lamborghini Huracán EVO',cat:'vehicle',catName:'Vehicles',price:250000,unit:'day',rating:5.0,reviews:22,loc:'Banana Island, Lagos',providerId:'pa',provider:'Prestige Auto',pAvatar:'PA',verified:true,mode:'request',deposit:500000,desc:'Self-drive or chauffeured, fully insured, 100km/day included. Turn heads at your next event.',specs:['630hp V10, self-drive or chauffeured','100km/day included, ₦850/km after','Comprehensive insurance included','Valid driver\'s licence + ₦500,000 deposit']},
  {id:'l4',title:'Furnished 2-Bed Shortlet Apartment',cat:'realestate',catName:'Real Estate & Spaces',price:60000,unit:'night',rating:4.6,reviews:98,loc:'Lekki Phase 1, Lagos',providerId:'us',provider:'UrbanStay Lekki',pAvatar:'US',verified:true,mode:'instant',deposit:30000,desc:'Bright, fully furnished, gated estate with a private pool and 24/7 power — walking distance to the beach.',specs:['2 bedrooms, sleeps 4','Private pool, 24/7 power & water','Gated estate with security','5 min walk to the beach']},
  {id:'l5',title:'Professional PA & DJ Equipment Set',cat:'music',catName:'Musical Instruments',price:35000,unit:'day',rating:4.9,reviews:64,loc:'Ikeja, Lagos',providerId:'sw',provider:'SoundWave Pro',pAvatar:'SW',verified:true,mode:'instant',deposit:15000,desc:'Dual 15" active speakers, wireless mics and a Pioneer controller — sound for up to 300 guests.',specs:['2× 15" active speakers, 2400W','Pioneer DDJ controller','2 wireless handheld mics','Delivery available within Lagos']},
  {id:'l6',title:'Heavy-Duty Scaffolding Set',cat:'tools',catName:'Tools & Construction',price:18000,unit:'day',rating:4.5,reviews:41,loc:'Ajah, Lagos',providerId:'br',provider:'BuildRight Equipment',pAvatar:'BR',verified:true,mode:'request',deposit:25000,desc:'Galvanized full-bay scaffolding with guard rails, suitable for facades up to 4 storeys.',specs:['Galvanized steel, corrosion resistant','Guard rails on every level','Suitable up to 4 storeys','Transport quoted separately']},
  {id:'l7',title:'Canon EOS R5 + L-Series Kit',cat:'av',catName:'AV Equipment',price:30000,unit:'day',rating:4.8,reviews:73,loc:'Yaba, Lagos',providerId:'cp',provider:'Canon Pro Rentals',pAvatar:'CP',verified:true,mode:'instant',deposit:60000,desc:'Full-frame body with 24-70mm and 70-200mm L lenses, extra batteries and a 128GB card.',specs:['45MP full-frame, 8K RAW video','24-70mm f/2.8L + 70-200mm f/2.8L','3 batteries, 128GB CFexpress','Padded hard case included']},
  {id:'l8',title:'Rooftop Event Space, Victoria Island',cat:'realestate',catName:'Real Estate & Spaces',price:120000,unit:'day',rating:4.7,reviews:31,loc:'Victoria Island, Lagos',providerId:'us',provider:'UrbanStay Lekki',pAvatar:'US',verified:true,mode:'request',deposit:60000,desc:'Skyline-view rooftop with in-house lighting rig, ideal for launches and intimate receptions of up to 80.',specs:['Capacity up to 80 guests','In-house lighting & PA hookup','Backup generator on site','Caterer-friendly service lift']},
  {id:'l9',title:'Tailored Agbada, 3-Piece',cat:'clothing',catName:'Fashion & Attire',price:20000,unit:'day',rating:4.9,reviews:19,loc:'Ikoyi, Lagos',providerId:'ec',provider:'EventCraft NG',pAvatar:'EC',verified:true,mode:'instant',deposit:10000,desc:'Hand-embroidered 3-piece agbada, dry-cleaned and pressed before every booking.',specs:['Hand embroidery, made to measure sizing','Dry-cleaned before every rental','Comes with matching cap','48hr notice for alterations']},
  ...
  {id:'l11',title:'Yamaha Grand Piano, Studio Upright',cat:'music',catName:'Musical Instruments',price:28000,unit:'day',rating:4.9,reviews:14,loc:'Victoria Island, Lagos',providerId:'sw',provider:'SoundWave Pro',pAvatar:'SW',verified:true,mode:'request',deposit:80000,desc:'Freshly tuned studio upright, moved and tuned on-site by our technician for the duration of your rental.',specs:['Tuned on delivery','Professional movers included','Climate-stable transport','Insurance included in price']},
  {id:'l12',title:'42ft Speedboat Charter, Half Day',cat:'boats',catName:'Marine & Watercraft',price:180000,unit:'day',rating:4.8,reviews:27,loc:'Ikoyi, Lagos',providerId:'pa',provider:'Prestige Auto',pAvatar:'PA',verified:true,mode:'request',deposit:100000,desc:'Captain-operated 42ft speedboat, life jackets and cooler included, half-day charter around Lagos waterways.',specs:['Captain & crew included','Life jackets for up to 12','Cooler and bluetooth sound system','Fuel included up to 3 hours']},
  {id:'l13',title:'Toyota Hilux Pickup Truck',cat:'vehicle',catName:'Vehicles',price:40000,unit:'day',rating:4.6,reviews:47,loc:'Ojo, Lagos',providerId:'pa',provider:'Prestige Auto',pAvatar:'PA',verified:true,mode:'instant',deposit:35000,desc:'Double-cab 4x4 pickup with an open bed, ideal for moving furniture, building materials or market goods across town.',specs:['Double-cab, 4x4, manual','1-tonne open bed capacity','150km/day included','Driver available on request']},
  {id:'l14',title:'Mercedes-Benz Sprinter Cargo Van',cat:'vehicle',catName:'Vehicles',price:45000,unit:'day',rating:4.7,reviews:33,loc:'Apapa, Lagos',providerId:'pa',provider:'Prestige Auto',pAvatar:'PA',verified:true,mode:'request',deposit:40000,desc:'Enclosed cargo van for house moves, event logistics or bulk deliveries — loading assistance available on request.',specs:['11m³ enclosed cargo space','Loading assistance available','150km/day included','Driver included']},
  {id:'l15',title:'Massey Ferguson Farm Tractor',cat:'tools',catName:'Tools & Construction',price:70000,unit:'day',rating:4.6,reviews:18,loc:'Epe, Lagos',providerId:'br',provider:'BuildRight Equipment',pAvatar:'BR',verified:true,mode:'request',deposit:100000,desc:'75HP tractor with plough and harrow attachments, operator included — suited to land clearing and farm preparation.',specs:['75HP, plough & harrow attachments','Trained operator included','Fuel billed separately','Suitable for land clearing & tilling']},
  {id:'l16',title:'Canopy, Chairs & Tables Package (100 Guests)',cat:'event',catName:'Event & Party',price:28000,unit:'day',rating:4.7,reviews:56,loc:'Ajah, Lagos',providerId:'ec',provider:'EventCraft NG',pAvatar:'EC',verified:true,mode:'instant',deposit:12000,desc:'The everyday event essentials — a durable canopy, plastic chairs and round tables for up to 100 guests, delivered and set up.',specs:['Canopy for up to 100 guests','100 plastic chairs, 10 round tables','Delivery and setup included','Pickup the next day']},
  {id:'l17',title:'Electric Concrete Mixer (140L)',cat:'tools',catName:'Tools & Construction',price:13000,unit:'day',rating:4.4,reviews:29,loc:'Ikorodu, Lagos',providerId:'br',provider:'BuildRight Equipment',pAvatar:'BR',verified:true,mode:'instant',deposit:15000,desc:'140-litre electric concrete mixer, well maintained and tested before every rental — ideal for small to mid-size building projects.',specs:['140-litre drum capacity','Single-phase electric motor','Tested before every rental','Transport quoted separately']},
];

const BOOKINGS=[
  {id:'b1',listingId:'l4',title:'Furnished 2-Bed Shortlet Apartment',cat:'realestate',status:'upcoming',dateFrom:'2026-07-18',dateTo:'2026-07-21',total:180000,provider:'UrbanStay Lekki'},
  {id:'b2',listingId:'l2',title:'DJI Mavic 3 Pro Drone Kit',cat:'av',status:'completed',dateFrom:'2026-06-02',dateTo:'2026-06-03',total:50000,provider:'AeroLens Rentals'},
  {id:'b3',listingId:'l1',title:'Premium Event Tent & Décor Package',cat:'event',status:'pending',dateFrom:'2026-08-09',dateTo:'2026-08-10',total:90000,provider:'EventCraft NG'},
  {id:'b4',listingId:'l7',title:'Canon EOS R5 + L-Series Kit',cat:'av',status:'completed',dateFrom:'2026-05-14',dateTo:'2026-05-15',total:30000,provider:'Canon Pro Rentals'},
  {id:'b5',listingId:'l6',title:'Heavy-Duty Scaffolding Set',cat:'tools',status:'cancelled',dateFrom:'2026-04-02',dateTo:'2026-04-05',total:54000,provider:'BuildRight Equipment'},
];
...
const POPULAR_SEARCHES=['Scaffolding','Wedding tuxedo','Sound system','Exotic cars','Camera kits'];
const LOCATIONS=[['Lekki Phase 1','Lagos'],['Victoria Island','Lagos'],['Ikeja','Lagos'],['Ajah','Lagos'],['Yaba','Lagos'],['Banana Island','Lagos'],['Wuse II','Abuja'],['Garki','Abuja'],['GRA','Port Harcourt']];
...
function rcard(l,feature=false,opts={}){
  ...
  return `<a class="rcard ${feature?'feature':''}" href="${href}">
    <div class="rcard-media">
      ...
      <div class="rcard-top">
        <div class="badge-row">${l.verified?`<div class="badge float verified">${icon('check',{size:11,stroke:2.6})}Verified</div>`:''}${l.mode==='instant'?`<div class="badge float instant">${icon('check',{size:11,stroke:2.6})}Instant Book</div>`:''}</div>
