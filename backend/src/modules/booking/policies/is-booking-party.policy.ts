...
/**
 * Either the renter who made the booking or the provider who owns the
 * listing — used for actions like cancel that either side can take.
 * Depends only on exported services — see IsListingOwnerPolicy's doc
 * comment for why a module-internal repository doesn't resolve here.
 */
@Injectable()
export class IsBookingPartyPolicy implements PolicyHandler {
  constructor(
